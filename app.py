...
def check_password():
    ...
    <div style="text-align: center; padding: 60px 20px;">
        <h1 style="color: {MD_RED}; font-size: 3rem; margin-bottom: 10px;">VERA-MD</h1>
        <p style="color: #666; font-size: 1.1rem; margin-bottom: 40px;">
            Verification Engine for Results &amp; Accountability<br>Maryland Implementation
        </p>
    </div>
    ...
    with col2:
        ...
        if st.button("Access VERA-MD", use_container_width=True):
    ...
    <div style="text-align: center; margin-top: 60px; color: #999; font-size: 0.85rem;">
        <p>VERA-MD analyzes ACCESS for ELLs domain data and MCAP results across Maryland LEAs.</p>
        <p>112,081 English Learners | 24 LEAs | Blueprint for Maryland's Future: $3.8B reform</p>
